...
- $X \perp Y | Z$ (conditioning on the sun rising, the rooster crowing has no information on the temperature or not)
...
- $X$: person signs up for causal inference course, $M$: person studies causal inference, $Y$: person understands causal inference
- $X \mathrel{\not\!\perp} Y$ (i.e. $X$ and $Y$ are dependent)
- $X \perp Y | M$
