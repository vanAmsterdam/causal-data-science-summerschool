...
<!-- This is the setup of RATE and related Qini / prescriptive-effect curves [@yadlowskyEvaluatingTreatment2023; @imaiExperimentalEvaluation2021]. -->
...
![](figs/rate_policy_value_curve.png){fig-align="center"}
...
$$
\widehat{V}_f(u)=\frac{1}{n}\sum_{i=1}^n
\left[
\frac{\pi_{f,u}(X_i)T_iY_i}{e_i}
+
\frac{\{1-\pi_{f,u}(X_i)\}(1-T_i)Y_i}{1-e_i}
\right]
$$
...
c-for-benefit is another rank-based evaluation summary, but for a fixed **benefit score** $f$ [@hooglandEvaluatingIndividualized2023].
